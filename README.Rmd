...
`FIScH` has three modes of operation: *fixed*, *adaptive*, and *rolling adaptive*. 
*day-ahead*

- fixed: optimizes releases for each week once using fixed inflow forecasts and
executes the schedule using observed inflow

- day-ahead: optimizes the hydropower schedule, and re-optimizes the schedule each day of the week with updated inflow forecasts. The schedule is still executed each day using observed inflow
...
extended beyond the end of a week. Optimization of the schedule is still done week-by-week, but these options expand the decision space.
