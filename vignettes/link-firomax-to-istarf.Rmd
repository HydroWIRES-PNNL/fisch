---
title: "How to link fisch to an ISTARF weekly reservoir policy"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to link fisch to ISTARF weekly reservoir policy}
...
# 1. Set up a table of initial conditions (matching headers in fisch output)
...
Using the above approach, `fisch` can be linked to a weekly reservoir simulation based on reservoir rules provided by the Inferred Storage Targets and Release Functions dataset [https://zenodo.org/record/4602277#.YuRaGC-B1z8](ISTARF-CONUS).
